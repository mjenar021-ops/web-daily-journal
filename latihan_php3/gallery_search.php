...
$sql = "SELECT * FROM gallery 
        WHERE judul LIKE ? OR deskripsi LIKE ? OR tanggal LIKE ? OR username LIKE ?
        ...
        <td>
            ...
            if ($row["gambar"] != '') {
                if (file_exists('img/' . $row["gambar"] . '')) {
                    echo '<img src="img/' . $row["gambar"] . '" class="img-fluid" alt="Gambar Gallery" style="max-height: 200px;">';
                }
            }
            ?>
        </td>
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Tuliskan Deskripsi Gallery" name="deskripsi"><?= $row["deskripsi"] ?></textarea>
                                </div>
                                <div class="mb-3">
