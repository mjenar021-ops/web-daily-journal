    ...
    <div class="row mb-2">
        ...
        <div class="col-md-6">
            <div class="input-group">
                <input type="text" id="search" class="form-control" placeholder="Masukan minimal 3 karakter untuk pencarian...">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Tuliskan Deskripsi Gallery" name="deskripsi"></textarea>
                            </div>
                            <div class="mb-3">
...
if (isset($_POST['simpan'])) {
    ...
    if ($nama_gambar != '') {
        ...
        if ($cek_upload['status']) {
            ...
            //jika false maka message berisi pesan error
            echo "<script>
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt->bind_param("sssssi", $judul, $deskripsi, $gambar, $tanggal, $username, $id);
        $simpan = $stmt->execute();
    } else {
        //jika tidak ada id, lakukan insert data baru
        $stmt = $conn->prepare("INSERT INTO gallery (judul, deskripsi, gambar, tanggal, username)
                                VALUES (?,?,?,?,?)");
