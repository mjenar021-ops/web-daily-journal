...
<html lang="en">
  ...
  <body>
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/Bermain Permainan Bersama Teman.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/Hangout Bersama Teman.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/kelompok Bersama Teman.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/Perpustakaan Kampus.jpg" class="d-block w-100" alt="..." />
            </div>
             <div class="carousel-item">
              <img src="img/Ruang Kelas.jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                  Pendidikan Agama Kristen<br />16.20-18.00 | Kulino
                </li>
                <li class="list-group-item">
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/rzkychyrmdhn__"
          ><i class="bi bi-instagram h2 p-2"></i
        ></a>
        <a href="https://twitter.com/udinusofficial"
          ><i class="bi bi-twitter h2 p-2"></i
        ></a>
        <a href="https://wa.me/+6281225664725"
