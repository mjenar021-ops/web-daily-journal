...
<html lang="en">
  ...
  <body>
    ...
    <footer class="text-center p-3 bg-danger-subtle">
			<div>
				<a href="https://www.instagram.com/d4vdc5"><i class="bi bi-instagram h2 p-2 text-dark"></i></a>
				<a href="https://twitter.com/udinusofficial"><i class="bi bi-twitter h2 p-2 text-dark"></i></a>
				<a href="https://wa.me/+6281381308579"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a>
			</div>
			<div>David Cornelius Saputra &copy; 2025</div>
    </footer>
    <!-- footer end -->
